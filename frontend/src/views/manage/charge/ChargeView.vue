<template>
  <a-modal v-model="show" title="充电桩信息详情" @cancel="onClose" :width="800">
    ...
    <div style="font-size: 13px;font-family: SimHei;" v-if="housesData !== null">
      <a-row style="padding-left: 24px;padding-right: 24px;">
        <a-col style="margin-bottom: 15px"><span style="font-size: 15px;font-weight: 650;color: #000c17">充电桩信息</span></a-col>
