    ...
    <div style="font-size: 13px;font-family: SimHei" v-if="rentData !== null">
      ...
      <a-row style="padding-left: 24px;padding-right: 24px;">
        ...
        <a-col :span="8"><b>出租状态：</b>
          <span v-if="rentData.delFlag == 1">上架</span>
          <span v-if="rentData.delFlag == 2">下架</span>
        </a-col>
        <a-col :span="8"><b>类型：</b>
          <span v-if="rentData.type == 1">出租</span>
          <span v-if="rentData.type == 2">售卖</span>
        </a-col>
      </a-row>
      <br/>
      ...
      <a-row style="padding-left: 24px;padding-right: 24px;">
        ...
        <a-col :span="24"><b>房屋地址：</b>
          {{ rentData.address !== null ? rentData.address : '- -' }}
        </a-col>
      </a-row>
      <br/>
      <a-row style="padding-left: 24px;padding-right: 24px;">
        ...
        <a-col :span="8"><b>房间号：</b>
          {{ rentData.number !== null ? rentData.number : '- -' }}
        </a-col>
        <a-col :span="8"><b>楼层：</b>
      ...
      <a-row style="padding-left: 24px;padding-right: 24px;">
        <a-col :span="8"><b>使用面积：</b>
          {{ rentData.usageArea !== null ? rentData.usageArea : '- -' }}平方米
        </a-col>
        <a-col :span="8"><b>建筑面积：</b>
          {{ rentData.surfaceArea !== null ? rentData.surfaceArea : '- -' }}平方米
        </a-col>
        <a-col :span="8"><b>房间数量：</b>
          {{ rentData.rooms !== null ? rentData.rooms : '- -' }}间
        </a-col>
      </a-row>
      <br/>
      <a-row style="padding-left: 24px;padding-right: 24px;">
