...
import HousesAdd from './ChargeAdd.vue'
import HousesEdit from './ChargeEdit.vue'
import HousesView from './ChargeView.vue'
...
export default {
    ...
    columns () {
      return [{
        ...
        customRender: (text, row, index) => {
          switch (text) {
            case '1':
              return <a-tag>快充</a-tag>
            case '2':
              return <a-tag>慢充</a-tag>
            default:
              return '- -'
          }
        }
  ...
  methods: {
    ...
    batchDelete () {
      ...
      this.$confirm({
        ...
        onOk () {
          ...
          that.$delete('/cos/charge-station/' + ids).then(() => {
    ...
    fetch (params = {}) {
      ...
      this.$get('/cos/charge-station/page', {
        ...params
      }).then((r) => {
