...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public void regist(String username, String password, String name) throws Exception {
        ...
        OwnerInfo ownerInfo = ownerInfoService.getOne(Wrappers.<OwnerInfo>lambdaQuery().eq(OwnerInfo::getName, name));
        ownerInfoService.update(Wrappers.<OwnerInfo>lambdaUpdate().set(OwnerInfo::getUserId, user.getUserId()).eq(OwnerInfo::getId, ownerInfo.getId()));
